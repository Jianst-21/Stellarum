  ...
  return (
    <section className="min-h-[700px] flex flex-col justify-center items-center text-center px-6 max-w-[1280px] mx-auto py-24 relative overflow-hidden">
      <div className="relative z-10 flex flex-col items-center">
        ...
        <a
          href="#tata-surya"
          className="inline-flex items-center gap-3 bg-[#22D3EE] text-[#001f25] px-8 py-4 rounded font-['Geist'] text-sm font-bold hover:bg-[#22D3EE]/90 transition-colors duration-300 shadow-lg shadow-[#22D3EE]/20"
        >
